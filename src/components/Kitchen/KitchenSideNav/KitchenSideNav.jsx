...
const KitchenSideNav = ({activePage,setActivePage,setPageContent, showMobileSideNav, setshowMobileSideNav}) => {
  ...
  return (
    ...
    >
      <Link
        onClick={() => {
          ToggleAdminMode(userDispatch, false);
          ToggleKitchenMode(userDispatch, false);
        }}
        to={"/"}
