  ...
  return (
    <section className="w-full my-5" id="menu">
      <div className="flex items-center justify-center w-full">
        <p
          className={`text-2xl text-headingColor font-semi-bold capitalize relative before:absolute before:rounded before:content before:w-80 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-orange-400 to-orange-600 transition-all ease-in-out duration-100`}
        >
          Sri Lankan Spice Hot Menu
        </p>
      </div>

      {/* Menu Catrgories Buttons -> MenuButton.jsx */}
      <motion.div
...
{/* Menu Items Container - MenuConatiner.jsx */}
      <MenuContainer
